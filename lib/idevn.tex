...
%          avinash@aczoom.com
% modified: may 2001, 2007, 2009.
% Apr 2007: use of \fransdvng, \Largedvng, etc caused an extra space to
% be added after those commands - need to put % comment start after
% magstep1, etc in \Largedvng, etc definitions
% ----
% 2009:
...
% \let\usedvng=\largedvng % usedvng is used by \fransdvng or \postdvng
...
% Apr 2007: careful with multi-line commands - add % immediately after
% magstep, or when using font at 12pt etc to swallow up newline, etc

% 10pt text
\def\normaldvng{
    \iffrans
        \font\devnfont=dvnb10
        \font\englfont=cmr10
    \else
...
% 10.95pt text
\def\largedvng{\iffrans \font\devnfont=dvnb10 scaled\magstephalf%
...
% 12pt text
\def\Largedvng{\iffrans \font\devnfont=dvnb10 scaled\magstep1%
...
% 14.4pt text
\def\LARGEdvng{\iffrans \font\devnfont=dvnb10 scaled\magstep2% 14.4pt
...
% 17.28pt text
\def\hugedvng{\iffrans \font\devnfont=dvnb10 scaled\magstep3% 17.28pt
...
% 20.74pt text
\def\Hugedvng{\iffrans \font\devnfont=dvnb10 scaled\magstep4% 20.74
